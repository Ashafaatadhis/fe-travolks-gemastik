        ...
        <div className="lg:p-8">
          <div className="mx-auto flex w-full flex-col justify-center space-y-6 sm:w-[350px]">
            <div className="flex flex-col space-y-2 text-center">
              <h1 className="text-2xl font-semibold tracking-tight text-custom-Fly-byNight"> {/* Mengubah warna teks */}
                Create an account
              </h1>
              <p className="text-sm text-muted-foreground"> {/* Mengubah warna teks */}
                Enter your email below to create your account
              </p>
            </div>
            <SignupForm />
            <p className="px-8 text-center text-sm text-muted-foreground"> {/* Mengubah warna teks */}
