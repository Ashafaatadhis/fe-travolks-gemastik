    ...
    <>
      ...
      <div className="container relative hidden h-[800px] flex-col items-center justify-center md:grid lg:max-w-none lg:grid-cols-2 lg:px-0">
        ...
        <div className="relative hidden h-full flex-col bg-muted p-10 text-white lg:flex dark:border-r">
          <div className="absolute inset-0 bg-custom-BlueOyster-Cult" />
          <div className="relative z-20 flex items-center text-lg font-medium text-custom-Grams-Hair">
            <svg
          ...
          <div className="relative z-20 mt-auto">
            <blockquote className="space-y-2">
              <p className="text-lg text-custom-Grams-Hair">
                &ldquo;This library has saved me countless hours of work and
                helped me deliver stunning designs to my clients faster than
                ever before.&rdquo;
              </p>
              <footer className="text-sm text-custom-Cloudless">Travolks developer</footer>
            </blockquote>
          </div>
        </div>
